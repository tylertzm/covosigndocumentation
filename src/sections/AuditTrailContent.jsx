    ...
    <section id="audit-storage" className="mb-16 scroll-mt-32">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 text-sm text-slate-700 space-y-2">
        <p>
          <strong>Path:</strong>{" "}
          <code>
            s3://your-bucket/audit-trails/{`{requestId}`}/audit-trail.pdf
          </code>
        </p>
        <p>
          <strong>On-demand:</strong> Use the download endpoint to generate and
          stream a fresh PDF.
        </p>
        <p>
          <strong>Stored copy:</strong> Use the saved S3 URL on the signed
          document for faster retrieval.
        </p>
      </div>
      <div className="mt-4 bg-slate-50 border border-slate-200 rounded-lg p-4 text-sm text-slate-700 space-y-2">
        <p>
          ...
          <code>
            AUD-{`{shortId}`}-{`{timestamp}`}.pdf
          </code>
        </p>
        <ul className="list-disc list-inside text-sm text-slate-600">
          <li>
            Prefix: <code>AUD</code>
          </li>
          <li>Short ID: first 8 chars of request UUID</li>
          <li>
            Timestamp: <code>yyyyMMdd-HHmmss</code>
          </li>
          <li>
    ...
    <section id="audit-config" className="mb-16 scroll-mt-32">
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
          ...
          <p className="text-xs text-slate-600 mb-2">
            Audit trails are generated as PDFs with configurable branding and
            layout.
          </p>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
          ...
          <ul className="list-disc list-inside text-xs text-slate-600 space-y-1">
            <li>
              <code>includeAuditTrail</code> on request payload (default: true)
            </li>
            <li>
              <code>signature.audit-trail.enabled=true</code>
            </li>
            <li>
              <code>signature.audit-trail.store-pdf=true</code>
            </li>
            <li>
              <code>storage.audit-trail.path-prefix=audit-trails/</code>
            </li>
            <li>
              <code>storage.audit-trail.retention-days=2555</code> (7 years)
            </li>
          </ul>
        </div>
      </div>
      <div className="mt-4 bg-slate-50 border border-slate-200 rounded-lg p-4 text-sm text-slate-700">
        ...
        <CodeBlock
          language="java"
          code={`// From createDocxFromContext method
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="border border-slate-200 rounded-lg p-5">
          ...
          <p className="text-xs text-slate-600 mb-3">
            Ensure the template exists and dependencies load.
          </p>
        ...
        <div className="border border-slate-200 rounded-lg p-5">
          ...
          <p className="text-xs text-slate-600 mb-3">
            Verify PDF generation dependencies and configuration.
          </p>
          <code className="text-xs bg-slate-100 px-1 py-0.5 rounded">
            Check PDF library and template settings
          </code>
        </div>
        <div className="border border-slate-200 rounded-lg p-5">
          <h4 className="font-bold text-slate-800 mb-2 text-sm">
          ...
          <p className="text-xs text-slate-600 mb-3">
            Confirm recipients are completed and IPs captured.
          </p>
          <code className="text-xs bg-slate-100 px-1 py-0.5 rounded">
        ...
        <div className="border border-slate-200 rounded-lg p-5">
          <h4 className="font-bold text-slate-800 mb-2 text-sm">
            Timezone Showing UTC
          </h4>
          <p className="text-xs text-slate-600 mb-3">
            Check TimeZoneResolver and IP capture. Force a zone if needed.
          </p>
          <code className="text-xs bg-slate-100 px-1 py-0.5 rounded">
