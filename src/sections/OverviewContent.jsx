    ...
    <div className="mb-10">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-green-800">
          Imagine you have a paper document that needs signatures from multiple
          people. Instead of printing, mailing, and waiting weeks, CovoSign lets
          you do it all online. You upload the document, add signature boxes,
          invite people via email, and they sign from their phone or computer.
          It's like digital paperwork that saves time and trees!
        </p>
      </div>
      <p className="text-lg text-slate-600 leading-relaxed mb-6">
        CovoSign is a digital signature platform to create, send, and manage
        end-to-end signing workflows. Upload documents, place fields, invite
        recipients by email, and track completion with built-in audit trails.
      </p>
      ...
      <div className="bg-white border border-slate-200 rounded-lg p-4">
        ...
        <ol className="list-decimal list-inside text-sm text-slate-600 space-y-1">
          ...
          <li>
            Track status, download the signed file, and access the audit trail.
          </li>
        </ol>
      </div>
    </div>
    <div className="grid md:grid-cols-2 gap-6">
      <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
        ...
        <p className="text-slate-600 text-sm">
          Predictable resource-oriented URLs, standard HTTP response codes, and
          JSON-encoded request/response bodies.
        </p>
      </div>
      <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
        <h3 className="font-bold text-slate-900 mb-2 flex items-center gap-2">
        ...
        <p className="text-slate-600 text-sm">
          Bank-grade security with API Key authentication, HMAC webhook
