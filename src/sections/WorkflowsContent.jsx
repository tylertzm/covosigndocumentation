...
const WorkflowsContent = () => (
    ...
    <div className="mb-10">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-green-800">
          Workflows are the steps people follow to sign a document. Some
          documents need one person to sign, others need multiple people in
          order or at the same time. CovoSign lets you set up these workflows so
          the signing happens in the right sequence, like a team approving a
          contract step by step.
        </p>
      </div>
      <p className="text-lg text-slate-600 leading-relaxed">
        CovoSign supports flexible signer workflows, including single-signer,
        parallel multi-signer, and sequential approval chains.
      </p>
    </div>

    <section id="workflow-single" className="mb-16">
      ...
      <div className="grid grid-cols-1 gap-8 mb-6">
        <div>
          <p className="text-slate-600 mb-4">
            The simplest workflow sending a document to one recipient for
            signature.
          </p>
          <div className="bg-slate-50 rounded-lg p-5 border border-slate-200">
            ...
            <p className="text-xs text-slate-600 mb-3">
              Upload Document → Add Recipient → Place Fields → Create Request →
              Send → Sign → Complete
            </p>
            <MermaidDiagram
              chart={`flowchart TD
  ...
  "recipients": [
    ...
    <div className="mb-8">
      ...
      <p className="text-slate-600">
        Handle multiple recipients either simultaneously (Parallel) or in a
        specific order (Sequential) with automatic notifications and deadlines.
      </p>
    </div>

    <section
      id="workflow-parallel"
      className="mb-16 border-l-2 border-slate-200 pl-6"
    >
      ...
      <div className="bg-slate-50 rounded-lg p-4 mb-4 border border-slate-200">
        ...
        <p className="text-xs text-slate-600 mb-3">
          Send Request → All signers notified simultaneously → Any order signing
          → All Complete
        </p>
        <MermaidDiagram
          chart={`flowchart TD
      ...
      <div className="grid grid-cols-1 gap-8">
        <div className="bg-green-50/50 rounded-lg p-5 border border-green-100">
          ...
          <p className="text-sm text-green-800 mb-4">
            Set the same <code>order</code> (e.g., 1) for all recipients.
          </p>
  ...
  { "email": "party3@example.com", "name": "Party 3", "order": 1 }
    ...
    >
      ...
      <p className="text-slate-600 mb-4 text-sm">
        Recipients are notified and must sign in a strict specific order (e.g.,
        Employee &rarr; Manager &rarr; HR).
      </p>
      ...
      <div className="bg-slate-50 rounded-lg p-4 mb-4 border border-slate-200">
        ...
        <p className="text-xs text-slate-600 mb-3">
          Send Request → Signer 1 signs → Notify Signer 2 → Signer 2 signs →
          Notify Signer 3 → Signer 3 signs → Complete
        </p>
        <MermaidDiagram
          chart={`flowchart TD
    ...
    I --> J[Complete]`}
      ...
      <div className="grid grid-cols-1 gap-8">
        <div className="bg-green-50/50 rounded-lg p-5 border border-green-100">
          ...
          <p className="text-sm text-green-800 mb-4">
            Increment <code>order</code> (1, 2, 3...) for each step.
          </p>
          <ul className="space-y-2 text-sm text-slate-600">
        ...
        <table className="w-full text-sm text-left">
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            ...
            <tr>
              ...
              <td className="px-6 py-4 text-slate-600">
                Only when previous step complete
              </td>
            </tr>
            <tr>
              <td className="px-6 py-4 font-semibold text-slate-800">
